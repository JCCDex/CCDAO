...
contract AVA_v1 is Context, Ownable, ERC3525SlotEnumerable {
    ...
    constructor(
        ...
        require(minTransferValue_ > 0, "AVA_v1: min transfer value must be positive");
        require(maxTotalValue_ % minTransferValue_ == 0, "AVA_v1: max total value must be divisible by min transfer value");
    ...
    function mint(
        ...
        require(_currentTotalValue + value_ <= _maxTotalValue, "AVA_v1: exceeds max total value");
        
        require(value_ % _minTransferValue == 0, "AVA_v1: value must be a multiple of min transfer value");
    ...
    function burnValue(uint256 tokenId_, uint256 burnValue_) public onlyOwner {
        ...
        require(burnValue_ % _minTransferValue == 0, "AVA_v1: burn value must be a multiple of min transfer value");
    ...
    function transferFrom(
        ...
        require(value_ % _minTransferValue == 0, "AVA_v1: transfer value must be a multiple of min transfer value");
